...
CREATE TABLE `aiai_lp_data` (
  ...
  `VERSION` decimal(5,0) NOT NULL,
  `FLOW_INSTANCE_ID` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `aiai_lp_experiment_task` (
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `VERSION` decimal(5,0) NOT NULL,
  `FLOW_INSTANCE_ID` decimal(10,0) NOT NULL,
...
CREATE TABLE `aiai_lp_experiment_task_feature` (
  ...
  PRIMARY KEY (`ID`),
  KEY `AIAI_LP_EXPERIMENT_TASK_FEATURE_FLOW_INSTANCE_ID_IDX` (`FLOW_INSTANCE_ID`)
...
--
-- Table structure for table `aiai_lp_flow`
--

DROP TABLE IF EXISTS `aiai_lp_flow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `aiai_lp_flow`
--

LOCK TABLES `aiai_lp_flow` WRITE;
/*!40000 ALTER TABLE `aiai_lp_flow` DISABLE KEYS */;
INSERT INTO `aiai_lp_flow` VALUES (3,3,'simple-experiment',0,'processes:\r\n- code: experiment-1\r\n  collectResources: true\r\n  name: experiment\r\n  parallelExec: false\r\n  type: EXPERIMENT\r\n  metas:\r\n  - key: feature\r\n    value: simple-dataset',1,1);
/*!40000 ALTER TABLE `aiai_lp_flow` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aiai_lp_flow_instance`
--

DROP TABLE IF EXISTS `aiai_lp_flow_instance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `aiai_lp_flow_instance`
--

LOCK TABLES `aiai_lp_flow_instance` WRITE;
/*!40000 ALTER TABLE `aiai_lp_flow_instance` DISABLE KEYS */;
INSERT INTO `aiai_lp_flow_instance` VALUES (4,6,3,1551343003138,1551343588274,'poolCodes:\n  flow-instance-input-type:\n  - simple-dataset',3,1,5);
/*!40000 ALTER TABLE `aiai_lp_flow_instance` ENABLE KEYS */;
UNLOCK TABLES;
