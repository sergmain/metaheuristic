...
CREATE INDEX AIAI_LP_EXPERIMENT_TASK_FEATURE_WORKBOOK_ID_IDX
  ON AIAI_LP_EXPERIMENT_TASK_FEATURE (WORKBOOK_ID);
...
CREATE UNIQUE INDEX AIAI_LP_PLAN_CODE_UNQ_IDX
  ON AIAI_LP_FLOW (CODE);

CREATE TABLE AIAI_LP_WORKBOOK (
  ID            SERIAL PRIMARY KEY,
  VERSION       NUMERIC(5, 0)  NOT NULL,
