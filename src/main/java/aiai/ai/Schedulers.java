...
*/
    ...
    @Scheduled(initialDelay = 5_000, fixedDelayString = "#{ T(aiai.ai.utils.EnvProperty).minMax( environment.getProperty('aiai.station.artifact-cleaner.timeout'), 10, 60, 30)*1000 }")
    public void artifactCleaner() {
        artifactCleaner.fixedDelay();
    }
