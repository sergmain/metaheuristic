...
public class TestSequenceYaml {
    ...
    public void testSequenceYaml() {
        ...
        list.add(new ExperimentService.SimpleSnippet(SnippetType.fit.toString(), "123"));
        list.add(new ExperimentService.SimpleSnippet(SnippetType.predict.toString(), "456"));
