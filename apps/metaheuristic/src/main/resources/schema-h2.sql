...
(version, COMPANY_ID, USERNAME, PASSWORD, PUBLIC_NAME, ROLES, CREATED_ON, UPDATED_ON)
VALUES
(0, 1, 'rest_user', '$2a$10$jaQkP.gqwgenn.xKtjWIbeP4X.LDJx92FKaQ9VfrN2jgdOUTPTMIu', 'Rest user', 'ROLE_ASSET_REST_ACCESS, ROLE_SERVER_REST_ACCESS', datediff('ms', '1970-01-01', CURRENT_DATE), datediff('ms', '1970-01-01', CURRENT_DATE));

insert into mh_account
(version, COMPANY_ID, USERNAME, PASSWORD, PUBLIC_NAME, ROLES, CREATED_ON, UPDATED_ON)
VALUES
(0, 2, 'admin', '$2a$10$jaQkP.gqwgenn.xKtjWIbeP4X.LDJx92FKaQ9VfrN2jgdOUTPTMIu', 'admin for company #1', 'ROLE_ADMIN, ROLE_BILLING, ROLE_OPERATOR', datediff('ms', '1970-01-01', CURRENT_DATE), datediff('ms', '1970-01-01', CURRENT_DATE));
