...
insert into mh_company_revision (version, COMPANY_ID, REVISION, NAME, PARAMS, IS_DELETED, CREATED_ON)
    VALUES (0, (select ID from mh_company where UNIQUE_ID=1), 1, 'Management company', '', false, datediff('ms', '1970-01-01', CURRENT_DATE));
...
insert into mh_company (version, UNIQUE_ID, IS_DELETED, HEAD_REVISION_ID) VALUES (0, 2, false, null);
insert into mh_company_revision (version, COMPANY_ID, REVISION, NAME, PARAMS, IS_DELETED, CREATED_ON)
    VALUES (0, (select ID from mh_company where UNIQUE_ID=2), 1, 'Company #1', '', false, datediff('ms', '1970-01-01', CURRENT_DATE));
...
(version, COMPANY_ID, is_acc_not_expired, is_not_locked, is_cred_not_expired, is_enabled, USERNAME, PASSWORD, ROLES, CREATED_ON, IS_DELETED, HEAD_REVISION_ID)
VALUES
(0, 1, true, true, true, true, 'rest_user', '$2a$10$jaQkP.gqwgenn.xKtjWIbeP4X.LDJx92FKaQ9VfrN2jgdOUTPTMIu', 'ROLE_ASSET_REST_ACCESS, ROLE_SERVER_REST_ACCESS', datediff('ms', '1970-01-01', CURRENT_DATE), false, null);
insert into mh_account_revision
(version, ACCOUNT_ID, REVISION, PUBLIC_NAME, UPDATED_ON, IS_DELETED, CREATED_ON)
VALUES
(0, (select ID from mh_account where USERNAME='rest_user'), 1, 'Rest user', datediff('ms', '1970-01-01', CURRENT_DATE), false, datediff('ms', '1970-01-01', CURRENT_DATE));
...
(version, COMPANY_ID, is_acc_not_expired, is_not_locked, is_cred_not_expired, is_enabled, USERNAME, PASSWORD, ROLES, CREATED_ON, IS_DELETED, HEAD_REVISION_ID)
VALUES
(0, 2, true, true, true, true, 'qqq', '$2a$10$jaQkP.gqwgenn.xKtjWIbeP4X.LDJx92FKaQ9VfrN2jgdOUTPTMIu', 'ROLE_ADMIN', datediff('ms', '1970-01-01', CURRENT_DATE), false, null);
insert into mh_account_revision
(version, ACCOUNT_ID, REVISION, PUBLIC_NAME, UPDATED_ON, IS_DELETED, CREATED_ON)
VALUES
(0, (select ID from mh_account where USERNAME='qqq'), 1, 'admin for company #1', datediff('ms', '1970-01-01', CURRENT_DATE), false, datediff('ms', '1970-01-01', CURRENT_DATE));
update mh_account set HEAD_REVISION_ID =
