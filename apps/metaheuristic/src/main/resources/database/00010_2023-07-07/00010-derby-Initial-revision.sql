...
1696034005027, false, null);
insert into mh_account_revision
(version, ACCOUNT_ID, REVISION, PUBLIC_NAME, UPDATED_ON, IS_DELETED, CREATED_ON)
VALUES
(0, (select ID from mh_account where USERNAME='rest_user'), 1, 'Rest user', 1696034005027, false, 1696034005027);
...
'ROLE_ADMIN', 1696034005027, false, null);
insert into mh_account_revision
(version, ACCOUNT_ID, REVISION, PUBLIC_NAME, UPDATED_ON, IS_DELETED, CREATED_ON)
VALUES
(0, (select ID from mh_account where USERNAME='qqq'), 1, 'admin for company #1', 1696034005027, false, 1696034005027);
update mh_account set HEAD_REVISION_ID =
