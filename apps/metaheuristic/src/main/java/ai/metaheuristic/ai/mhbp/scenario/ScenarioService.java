...
public class ScenarioService {
    ...
    public PreparedScenario prepareScenario(long scenarioId, UserContext context) {
        ...
        if (sc==null) {
            ...
            SourceCodeApiData.SourceCodeResult result = sourceCodeTxService.createSourceCode(yaml, uid, EnumsApi.SourceCodeLang.yaml, context.getCompanyId(), scpy.source.type);
            if (!result.isValid()) {
