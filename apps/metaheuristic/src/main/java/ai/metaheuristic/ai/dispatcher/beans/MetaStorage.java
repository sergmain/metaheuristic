 ...
 */
@Entity
@Table(name = "MH_META_STORAGE")
@Data
@TableGenerator(
        name = "mh_meta_storage_ids",
        table = "mh_gen_ids",
        pkColumnName = "sequence_name",
        valueColumnName = "sequence_next_value",
        pkColumnValue = "mh_meta_storage_ids",
        allocationSize = 1,
        initialValue = 1
)
public class MetaStorage implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "mh_meta_storage_ids")
    @Column(name = "ID")
    public Long id;
