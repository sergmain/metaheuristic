...
@Controller
@RequestMapping("/mh.dispatcher./company/batch")
@Slf4j
...
public class BatchForOperatorController {
    ...
    public String batches(
        ...
        return "mh.dispatcher./company/batch/company-batches";
    }
    ...
    public String batches(
        ...
        return "mh.dispatcher./company/batch/company-batches-usage-info";
    }
    ...
    public String batchesPart(Model model, @PageableDefault(size = 20) Pageable pageable, @PathVariable Long companyUniqueId) {
        ...
        model.addAttribute("result", batchesResult);
        model.addAttribute("companyUniqueId", companyUniqueId);
        return "mh.dispatcher./company/batch/company-batches :: table";
    }
    ...
    public String batchAdd(Model model, @PathVariable Long companyUniqueId) {
        ...
        model.addAttribute("companyUniqueId", companyUniqueId);
        return "mh.dispatcher./company/batch/company-batch-add";
    }
    ...
    public String processResourceDelete(
        ...
        if (status.isErrorMessages()) {
            ...
            return "redirect:/mh.dispatcher./company/batch/company-batches/" + companyUniqueId;
        }
        model.addAttribute("batchId", batchId);
        model.addAttribute("console", status.console);
        model.addAttribute("isOk", status.ok);
        model.addAttribute("companyUniqueId", companyUniqueId);
        return "mh.dispatcher./company/batch/company-batch-delete";
    }
    ...
    public String getProcessingResourceStatus(
        ...
        model.addAttribute("console", status.console);
        model.addAttribute("companyUniqueId", companyUniqueId);
        return "mh.dispatcher./company/batch/company-batch-status";
    }
