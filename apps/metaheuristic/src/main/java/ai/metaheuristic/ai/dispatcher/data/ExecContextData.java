...
public class ExecContextData {
     ...
     * entry still means "not supplied" and is refused. A null is accepted only for an input the SourceCode declares
     * nullable ('?'); for any other it is refused (01.562.124).
     */
