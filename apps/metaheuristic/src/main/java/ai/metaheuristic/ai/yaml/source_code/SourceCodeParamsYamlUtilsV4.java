...
public class SourceCodeParamsYamlUtilsV4
    ...
    @NonNull
    @Override
    public SourceCodeParamsYaml upgradeTo(@NonNull SourceCodeParamsYamlV4 v4) {
        v4.checkIntegrity();
    ...
    @NonNull
    private static SourceCodeParamsYaml.Process toProcess(SourceCodeParamsYamlV4.ProcessV4 o) {
    ...
    private static void toVariable(List<SourceCodeParamsYamlV4.VariableV4> src, List<SourceCodeParamsYaml.Variable> trg) {
