...
public class StandaloneDispatcherLookupExtendedParams extends DispatcherLookupExtendedParams {
    ...
    /*
      - signatureRequired: true
        ...
        priority: 1
    */
        DispatcherLookupParamsYaml.DispatcherLookup lookup = new DispatcherLookupParamsYaml.DispatcherLookup();
        ...
        lookup.taskProcessingTime = null;
        lookup.publicKey = null;
        lookup.priority = 1;

        DispatcherLookupParamsYaml dispatcherLookupConfig = new DispatcherLookupParamsYaml();
