...
public class MetaStorageSyntheticService {
    ...
    /**
     * One page of key list, for the browse screen. ❗ The page SIZE is the server's constant, never
     * the request's - see the production twin for why.
     */
    public Page<String> listKeys(Long companyId, String type, Pageable pageable) {
        return metaStorageSyntheticRepository.findRecKeyPageByCompanyIdAndType(
