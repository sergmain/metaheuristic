...
public class CustomUserDetails implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // TODO 2020-12-24 implement a common way to check roles over ai.metaheuristic.ai.sec.SecConsts.MANAGEMENT_COMPANY_POSSIBLE_ROLES.
        // fix role, the role ROLE_SERVER_REST_ACCESS can't be assigned to any user whose company isn't the management company with id==1
        if (!Consts.MANAGEMENT_COMPANY_ID.equals(account.getCompanyId()) && account.accountRoles.hasRole(SecConsts.ROLE_SERVER_REST_ACCESS)) {
