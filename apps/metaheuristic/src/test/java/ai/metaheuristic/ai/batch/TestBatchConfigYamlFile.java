...
public class TestBatchConfigYamlFile {
    ...
    public void testParsing() throws IOException {
        ...
        try (InputStream is = TestBatchConfigYamlFile.class.getResourceAsStream("/yaml/batch/bad-config.yaml")) {
            BatchService.getMainDocument(is);
        }
    }
    ...
    public void testDirContent_01() throws IOException {
        ...
        try {
            ...
            File f = BatchService.getMainDocumentFileFromConfig(artifact, Map.of());
        }
        finally {
            if (dir!=null) {
...
//            thrown.expect(BatchResourceProcessingException.class);
            File f = BatchService.getMainDocumentFileFromConfig(artifact, Map.of("artifacts/aaa1.xml", "artifacts/aaa.xml", "artifacts/bbb1.xml", "artifacts/bbb.xml"));
        }
        finally {
            if (dir!=null) {
                FileUtils.deleteDirectory(dir);
