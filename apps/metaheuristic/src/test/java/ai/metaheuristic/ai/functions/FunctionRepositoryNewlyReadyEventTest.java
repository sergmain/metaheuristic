...
public class FunctionRepositoryNewlyReadyEventTest {
    ...
    public void test_processRequest_publishes_events_when_new_function_becomes_ready() throws Exception {
        ...
        // The readiness registry is backed by no table, which is why the three collaborators below
        // are never touched on this path.
        ExecutionGateService executionGateService = new ExecutionGateService(null, null, null);
