...
public class TestProcessGraph {
    ...
    public void test() {
        ...
        ExecContextData.ProcessVertex v1 = SourceCodeGraphLanguageYaml.getVertex(ids, currId, "code-1", "1");
        ExecContextProcessGraphService.addNewTasksToGraph(processGraph, v1, List.of());

        ExecContextData.ProcessVertex v2 = SourceCodeGraphLanguageYaml.getVertex(ids, currId, "code-2", "1");
