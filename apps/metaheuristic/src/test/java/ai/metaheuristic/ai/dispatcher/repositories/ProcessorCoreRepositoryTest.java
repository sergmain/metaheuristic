...
public class ProcessorCoreRepositoryTest {
    ...
    @Autowired
    private ProcessorCoreRepository processorCoreRepository;

    @Autowired
    private ProcessorCoreRepository processorRepository;

    @Autowired
    private ProcessorTxService processorTxService;
