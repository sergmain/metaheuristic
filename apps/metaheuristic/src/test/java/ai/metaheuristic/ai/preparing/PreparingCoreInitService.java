...
public class PreparingCoreInitService {
    ...
    public PreparingData.PreparingCodeData beforePreparingCore() {
        ...
        ProcessorStatusYaml ss = new ProcessorStatusYaml(envYaml,
                ...
                null, null, null);  // Stage 4: publicKeySpki, keyFingerprint + functions
    ...
    public void afterPreparingCore(PreparingData.@Nullable PreparingCodeData preparingCodeData) {
