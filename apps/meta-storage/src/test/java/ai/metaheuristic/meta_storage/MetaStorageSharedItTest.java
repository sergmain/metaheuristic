 ...
 * {@link MetaStorageSharedItEnv} H2 file DB, the single SQLite file, {@code mh.home} and the
 * Liquibase changelog. Every subclass resolves the SAME inherited {@code Method}, so Spring builds
...
public abstract class MetaStorageSharedItTest {
    ...
    static void sharedProps(DynamicPropertyRegistry r) {
        ...
        r.add("spring.liquibase.change-log",  () -> "classpath:database/meta-storage/meta-storage-changelog.yaml");
        r.add("spring.jpa.hibernate.ddl-auto", () -> "none");
        r.add("mh.home",                      () -> MetaStorageSharedItEnv.MH_HOME);
        r.add("mh.meta-storage.db-path",      () -> MetaStorageSharedItEnv.META_STORAGE_DB_PATH);
    }
}
