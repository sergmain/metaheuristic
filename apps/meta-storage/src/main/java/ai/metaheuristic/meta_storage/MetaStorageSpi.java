 ...
 * external Function: SQLite here, something else later, same two methods.
 *
 ...
 *
 * <p><b>Concurrency.</b> SQLite is a single-writer engine. Serialisation is an implementation
 * detail of the implementing class and is deliberately NOT a concern of the caller - the pipeline
 * author must not have to reason about it.
 *
 * @author Serge
 */
