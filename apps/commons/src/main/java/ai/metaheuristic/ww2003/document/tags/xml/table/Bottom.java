...
public class Bottom extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "bottom";
    ...
    public Bottom(Attr... attrs) {
        super(attrs);
        int i=0;
    }

    public Bottom(List<Attr> attrs) {
        super(attrs);
        int i=0;
    }
