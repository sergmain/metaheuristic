...
@NoArgsConstructor
public class TblCellMar extends Composite implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "tblCellMar";

    public TblCellMar(CDNode... nodes) {
        super(nodes);
    }
