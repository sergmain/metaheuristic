...
@NoArgsConstructor
public class DocumentProperties extends Composite implements XmlTag {

    private static final String NS = "o";
    private static final String TAG_NAME = "DocumentProperties";

    public DocumentProperties(CDNode... nodes) {
        super(nodes);
    }
