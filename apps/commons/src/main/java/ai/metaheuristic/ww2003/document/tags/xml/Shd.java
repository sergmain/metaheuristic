...
@NoArgsConstructor
public class Shd extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "shd";

    public Shd(List<Attr> attrs) {
        super(attrs);
    }

    public Shd(Attr... attrs) {
        super(attrs);
    }
