...
@NoArgsConstructor
public class TblBorders extends Composite implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "tblBorders";

    public TblBorders(CDNode... nodes) {
        super(nodes);
    }
