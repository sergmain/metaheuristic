...
@NoArgsConstructor
public class TCellWidth extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "tcW";

    public TCellWidth(Attr... attrs) {
        super(attrs);
    }

    public TCellWidth(List<Attr> attrs) {
        super(attrs);
    }
