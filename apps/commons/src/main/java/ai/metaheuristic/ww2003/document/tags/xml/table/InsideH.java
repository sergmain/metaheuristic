...
@NoArgsConstructor
public class InsideH extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "insideH";

    public InsideH(List<Attr> attrs) {
        super(attrs);
    }

    public InsideH(Attr... attrs) {
        super(attrs);
    }
