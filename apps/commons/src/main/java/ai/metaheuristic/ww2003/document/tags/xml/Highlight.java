...
@NoArgsConstructor
public class Highlight extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "highlight";

    public Highlight(List<Attr> attrs) {
        super(attrs);
    }

    public Highlight(Attr... attrs) {
        super(attrs);
    }
