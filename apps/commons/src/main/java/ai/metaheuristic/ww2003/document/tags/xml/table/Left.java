...
@NoArgsConstructor
public class Left extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "left";

    public Left(Attr... attrs) {
        super(attrs);
    }

    public Left(List<Attr> attrs) {
        super(attrs);
    }
