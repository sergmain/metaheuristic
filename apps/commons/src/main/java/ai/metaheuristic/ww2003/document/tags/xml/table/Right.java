...
@NoArgsConstructor
public class Right extends Leaf implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "right";

    public Right(Attr... attrs) {
        super(attrs);
    }

    public Right(List<Attr> attrs) {
        super(attrs);
    }
