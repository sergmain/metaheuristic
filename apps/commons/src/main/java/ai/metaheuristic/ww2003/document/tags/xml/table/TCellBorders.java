...
@NoArgsConstructor
public class TCellBorders extends Composite implements XmlTag, PropertyElement {

    private static final String NS = "w";
    private static final String TAG_NAME = "tcBorders";

    public TCellBorders(CDNode... nodes) {
        super(nodes);
    }
