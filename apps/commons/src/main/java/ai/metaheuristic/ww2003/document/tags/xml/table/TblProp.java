...
@NoArgsConstructor
public class TblProp extends Composite implements XmlTag, Property {

    private static final String NS = "w";
    private static final String TAG_NAME = "tblPr";

    public TblProp(Enums.Align align, CDNode... nodes) {
        super(nodes);
        setAlign(align);
    }

    public TblProp(CDNode... nodes) {
        super(nodes);
    }
