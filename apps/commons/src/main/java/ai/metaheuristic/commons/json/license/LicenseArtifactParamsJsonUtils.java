 ...
 * <br/>
 * Registry for the JSON multi-versioning chain backing {@code MH_LICENSE_ARTIFACT.PARAMS} — one installed license.
 *
 ...
 * @author Serge
 */
public class LicenseArtifactParamsJsonUtils {

    private static final LicenseArtifactParamsJsonUtilsV1 UTILS_V_1 = new LicenseArtifactParamsJsonUtilsV1();
    private static final LicenseArtifactParamsJsonUtilsV1 DEFAULT_UTILS = UTILS_V_1;

    @SuppressWarnings({"rawtypes", "unchecked"})
    public static final BaseJsonUtils<LicenseArtifactParams> BASE_JSON_UTILS =
        new BaseJsonUtils<>(
            (Map) Map.of(
