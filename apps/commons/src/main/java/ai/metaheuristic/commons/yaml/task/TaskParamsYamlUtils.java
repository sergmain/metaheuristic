...
public class TaskParamsYamlUtils {
    ...
    private static final TaskParamsYamlUtilsV5 YAML_UTILS_V_5 = new TaskParamsYamlUtilsV5();
    private static final TaskParamsYamlUtilsV5 DEFAULT_UTILS = YAML_UTILS_V_5;
