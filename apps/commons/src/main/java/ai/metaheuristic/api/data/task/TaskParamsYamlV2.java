...
public class TaskParamsYamlV2 implements BaseParams {
    ...
    public static class SnippetConfigYamlV2 implements Cloneable {
    ...
    public static class TaskYamlV2 {
        ...
        public SnippetConfigYamlV2 snippet;
        public List<SnippetConfigYamlV2> preSnippets;
        public List<SnippetConfigYamlV2> postSnippets;
