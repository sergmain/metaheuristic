...
public class TestFunctionConfigYaml {
    ...
    public void testUpgradeToV2() {
        ...
        assertEquals(sc2.sourcing, EnumsApi.FunctionSourcing.launchpad);
    ...
    private FunctionConfigYamlV1 getFunctionConfigYamlV1() {
        ...
        sc.params = "sc.params";
        sc.env = "sc.env";
        sc.sourcing = EnumsApi.FunctionSourcing.launchpad;
        sc.metrics = true;
    ...
    private void checkLatest(FunctionConfigYaml sc) {
        ...
        assertEquals(sc.sourcing, EnumsApi.FunctionSourcing.launchpad);
        assertNotNull(sc.ml);
    ...
    public void testNull() {
        ...
        assertEquals(sc1.sourcing, EnumsApi.FunctionSourcing.launchpad);
